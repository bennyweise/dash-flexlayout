...
export default {
  ...
  const Template: ComponentStory<typeof FlexLayout> = (args) => <FlexLayout {...args} />;
  ...
  Primary.args = {
    ...
    config: json,
    nodes: {
        "tab-1": <div>{"something here"}</div>,
        "tab-2": <div>{"something here in tab 2"}</div>,
        "tab-3": <div>{"something here in tab 3"}</div>,
    }
  };
