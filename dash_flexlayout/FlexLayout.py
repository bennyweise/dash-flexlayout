...
- useStateForModel (boolean; optional):
    ...
    _type = 'FlexLayout'
    @_explicitize_args
    def __init__(self, children=None, font=Component.UNDEFINED, supportsPopout=Component.UNDEFINED, popoutURL=Component.UNDEFINED, realtimeResize=Component.UNDEFINED, model=Component.REQUIRED, useStateForModel=Component.UNDEFINED, debugMode=Component.UNDEFINED, id=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'debugMode', 'font', 'model', 'popoutURL', 'realtimeResize', 'supportsPopout', 'useStateForModel']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'debugMode', 'font', 'model', 'popoutURL', 'realtimeResize', 'supportsPopout', 'useStateForModel']
